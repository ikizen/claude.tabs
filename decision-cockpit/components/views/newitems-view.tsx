  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-lg border border-sky-300 bg-sky-50 p-4 text-sm text-sky-900 dark:border-sky-900 dark:bg-sky-950 dark:text-sky-200">
        <p className="font-semibold">Откуда этот список</p>
        <p className="mt-1">
          Сюда попадают модели, которые недавно поступили на склад («Первый приход») и чей сезон продаж ещё не наступил или только начался
          («Сезон, старт» / «Мес. до сезона»). Список формируется в самом отчёте по учётным данным поступлений и сезонности, сайт его не
          пересчитывает — здесь только отображение.
        </p>
